...
<div class="card-body">
    ...
    <p class="mb-0">
        <span class="fw-medium me-1 {{ $productIncreasePercentage >= 0 ? 'text-success' : 'text-danger' }}">
...
<div class="card-body">
  <div class="d-flex align-items-center mb-2 pb-1">
      <div class="avatar me-2">
          <span class="avatar-initial rounded bg-label-warning"><i class="ti ti-shopping-cart ti-md"></i></span>
      </div>
...
<div class="col-sm-6 col-lg-3 mb-4">
  <div class="card card-border-shadow-danger">
      <div class="card-body">
          ...
          <p class="mb-0">
              <span class="fw-medium me-1 {{ $customerIncreasePercentage >= 0 ? 'text-success' : 'text-danger' }}">
...
<div class="col-sm-6 col-lg-3 mb-4">
  <div class="card card-border-shadow-info">
      <div class="card-body">
          ...
          <p class="mb-0">
              <span class="fw-medium me-1 {{ $resellerIncreasePercentage >= 0 ? 'text-success' : 'text-danger' }}">
